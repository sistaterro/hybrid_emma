...
- `ui/admin.html`
  - Administrative UI.
  - Connected to backend user management for creating users, renaming usernames, changing roles, enabling/disabling users, resetting passwords, and deleting users.
